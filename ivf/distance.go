...
//
// It is a function variable so architecture-specific builds can replace
// it with a hand-written kernel at init time (see distance_amd64.go
// and distance_arm64.go). Unsupported architectures keep dotGeneric.
